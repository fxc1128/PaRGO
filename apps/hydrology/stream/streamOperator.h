  ...
  public:
    streamOperator()
      :RasterOperator<double>(),
       _noData(-9999.), num(0),maxval(0.),length(0.),runtime(0.),_maxrow(0),_maxcol(0),_elevOut("elevOut"),_contribs("contribs"),_porderout(0),
       _pDirLayer(0), _pssaLayer(0),_pDEMLayer(0),s1(0.),s2(0.),s1sq(0.),s2sq(0.),n1(0),n2(0),totalarea(0.),
		_pareaLayer(0){}
